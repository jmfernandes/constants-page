...
"""earth"""
@app.route('/natural/earth/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/earth/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/earth/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/earth/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/earth/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/earth/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/earth/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/earth/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/earth/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/earth/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/earth/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/earth/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/earth/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/earth/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/earth/volume', endpoint='volume')
def index():
...
"""jupiter"""
@app.route('/natural/jupiter/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/jupiter/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/jupiter/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/jupiter/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/jupiter/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/escape_velocity', endpoint='escape_velocity')
def index():
...
def index():
    ...
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/jupiter/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/jupiter/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/jupiter/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/jupiter/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/jupiter/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/jupiter/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/jupiter/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/jupiter/volume', endpoint='volume')
def index():
...
"""mars"""
@app.route('/natural/mars/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/mars/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/mars/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/mars/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/mars/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/mars/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/mars/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/mars/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/mars/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/mars/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/mars/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/mars/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/mars/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/mars/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mars/volume', endpoint='volume')
def index():
...
"""mercury"""
@app.route('/natural/mercury/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/mercury/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/mercury/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/mercury/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/mercury/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/mercury/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/mercury/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/mercury/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/mercury/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/mercury/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/mercury/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/mercury/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/mercury/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/mercury/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/mercury/volume', endpoint='volume')
def index():
...
"""moon"""
@app.route('/natural/moon/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/moon/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/moon/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/moon/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/moon/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/moon/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/moon/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/moon/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/moon/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/moon/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/moon/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/moon/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/moon/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/moon/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/moon/volume', endpoint='volume')
def index():
...
"""neptune"""
@app.route('/natural/neptune/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/neptune/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/neptune/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/neptune/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/neptune/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/neptune/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/neptune/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/neptune/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/neptune/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/neptune/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/neptune/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/neptune/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/neptune/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/neptune/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/neptune/volume', endpoint='volume')
def index():
...
"""saturn"""
@app.route('/natural/saturn/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/saturn/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/saturn/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/saturn/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/saturn/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/saturn/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/saturn/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/saturn/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/saturn/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/saturn/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/saturn/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/saturn/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/saturn/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/saturn/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/saturn/volume', endpoint='volume')
def index():
...
"""uranus"""
@app.route('/natural/uranus/axial_tilt', endpoint='axial_tilt')
def index():
    json_file = open('templates/json/natural/uranus/axial_tilt.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/uranus/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/uranus/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/uranus/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/uranus/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/uranus/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/uranus/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/uranus/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/uranus/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/uranus/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/uranus/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/uranus/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/uranus/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/uranus/volume', endpoint='volume')
def index():
...
def index():
    ...
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/black_body_temperature', endpoint='black_body_temperature')
def index():
    json_file = open('templates/json/natural/venus/black_body_temperature.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/distance_from_sun', endpoint='distance_from_sun')
def index():
    json_file = open('templates/json/natural/venus/distance_from_sun.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/equatorial_radius', endpoint='equatorial_radius')
def index():
    json_file = open('templates/json/natural/venus/equatorial_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/escape_velocity', endpoint='escape_velocity')
def index():
    json_file = open('templates/json/natural/venus/escape_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/length_of_day', endpoint='length_of_day')
def index():
    json_file = open('templates/json/natural/venus/length_of_day.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/mass', endpoint='mass')
def index():
    json_file = open('templates/json/natural/venus/mass.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/mean_density', endpoint='mean_density')
def index():
    json_file = open('templates/json/natural/venus/mean_density.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/mean_orbital_velocity', endpoint='mean_orbital_velocity')
def index():
    json_file = open('templates/json/natural/venus/mean_orbital_velocity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/orbital_period', endpoint='orbital_period')
def index():
    json_file = open('templates/json/natural/venus/orbital_period.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/polar_radius', endpoint='polar_radius')
def index():
    json_file = open('templates/json/natural/venus/polar_radius.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/solar_irradiance', endpoint='solar_irradiance')
def index():
    json_file = open('templates/json/natural/venus/solar_irradiance.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/surface_gravity', endpoint='surface_gravity')
def index():
    json_file = open('templates/json/natural/venus/surface_gravity.json')
    data = json.load(json_file)
    json_file.close()
    return  render_template('webpage.html',data=data)
@app.route('/natural/venus/volume', endpoint='volume')
def index():
